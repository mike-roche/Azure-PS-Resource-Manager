$CustomerShortName = 'crc'
$Location = 'West US'
$LocationShortName = 'wu1'
$SharedResourceGroupName = ('rg-shd-{0}-1' -f $LocationShortName)
$FirewallSubnetAddressSpace = '10.0.0.192/26'
$BastionSubnetAddressSpace = '10.0.0.128/26'
$SharedSubnetAddressSpaces = @('10.0.0.0/26', '10.0.0.64/26')
$SharedVnetAddressSpace = '10.0.0.0/24'
$CustomerResourceGroupName = ('rg-{0}-{1}-1' -f $CustomerShortName, $LocationShortName)
$CustomerSubnetAddressSpaces = @('10.0.1.0/25','10.0.1.128/25','10.0.2.0/25','10.0.2.128/25')
$CustomerVnetAddressSpaces = @('10.0.1.0/24','10.0.2.0/24')
